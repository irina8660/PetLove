...
const InputField = ({
  ...
  // field - пропси для інпута (name, value, onChange, onBlur)
  // meta  - стан цього інпута: meta.value, meta.error, meta.touched
  // helpers - (не використовуємо тут) для ручного setValue/setTouched
